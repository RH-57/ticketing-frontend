                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row">
                                            <div className="col-12">
                                                <div className="preview-list" style={{ maxHeight: "250px", overflowY: "auto", paddingRight: "10px"}}>
                                                {
                                                                ...
                                                                <div className="preview-item-content d-sm-flex flex-grow">
                                                                    <div className="flex-grow">
                                                                        <h6 className="preview-subject">
                                                                            ...
                                                                            <span className={`badge badge-pill font-weight-bold mx-1 p-1 text-xs ${open.priority === "Critical" ? "badge-outline-danger" : open.priority === "High" ? "badge-outline-warning" : open.priority === "Medium" ? "badge-outline-success" : "badge-outline-primary"}`}>
                                                                                {open.priority}
                                                                            </span>
                                                                        </h6>
